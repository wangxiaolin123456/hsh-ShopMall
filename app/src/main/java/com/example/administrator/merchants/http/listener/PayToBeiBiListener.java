...
public class PayToBeiBiListener implements Response.Listener<JSONObject> {
    ...
    public PayToBeiBiListener(Context context, String money, String orderNo,String isSilver) {
    ...
    private void payBeiBiDialog(final String isSilver) {  //toDo  dialog-输入贝币密码
        ...
        beiBiDialogShowBean.getConfirm().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                checkBeiBiPassword(isSilver);//密码确认 请求网络
     ...
     * 确认支付密码
     */
    private void checkBeiBiPassword(String isSilver) {//toDO 跟后台的密码比对
        ...
        Http.confirmPayOrderPassword(context, confirmBeiBiPasswordPostBean, money, orderNo,isSilver);
    }
